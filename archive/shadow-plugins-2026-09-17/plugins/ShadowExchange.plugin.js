...
var require_dom_bus = __commonJS({
  "src/shared/dom-bus.js"(exports2, module2) {
    ...
    module2.exports = { onKeydown, onResize: onResize2 };
  }
});
...
var require_panel_components = __commonJS({
  "src/ShadowExchange/panel-components.js"(exports2, module2) {
    ...
    function getCachedMessagePreviewText(cached) {
      ...
      const attachmentCount = Number(((_a = cached.attachments) == null ? void 0 : _a.size) || ((_b = cached.attachments) == null ? void 0 : _b.length) || 0);
    ...
    function resolveMessagePreviewData(pluginInstance, wp) {
      ...
      try {
        const cached = (_a = pluginInstance.MessageStore) == null ? void 0 : _a.getMessage(wp.channelId, wp.messageId);
    ...
    function getWaypointListRevision(waypoints) {
      ...
      return waypoints.map((wp) => [
        (wp == null ? void 0 : wp.id) || "",
        (wp == null ? void 0 : wp.label) || "",
        (wp == null ? void 0 : wp.shadowName) || "",
        (wp == null ? void 0 : wp.shadowRank) || "",
        (wp == null ? void 0 : wp.createdAt) || 0,
        (wp == null ? void 0 : wp.lastVisited) || 0,
        (wp == null ? void 0 : wp.visitCount) || 0
      ].join(":")).join("|");
    }
...
var require_styles = __commonJS({
  "src/ShadowExchange/styles.js"(exports2, module2) {
    function getShadowExchangeCss2() {
      return `
...
`;
    ...
    function _writeVcAttribute() {
      try {
        ...
        const vcValue = isVoiceChannelChat2() ? "true" : "false";
    ...
    module2.exports = {
      getCurrentChannel,
      isVoiceChannelChat: isVoiceChannelChat2,
  ...
  "src/ShadowExchange/persistence.js"(exports2, module2) {
    ...
    function loadSettings2(plugin, defaultSettings, { pluginId }) {
      ...
      const score = (candidate) => {
        var _a, _b, _c;
        const ts = ((_b = (_a = candidate.data) == null ? void 0 : _a._metadata) == null ? void 0 : _b.lastSave) ? new Date(candidate.data._metadata.lastSave).getTime() || 0 : 0;
        const wpCount = Array.isArray((_c = candidate.data) == null ? void 0 : _c.waypoints) ? candidate.data.waypoints.length : 0;
        return ts * 1e3 + wpCount;
      };
      ...
      try {
        ...
        for (const candidatePath of paths) {
          try {
            ...
            const ts = ((_a = data == null ? void 0 : data._metadata) == null ? void 0 : _a.lastSave) ? new Date(data._metadata.lastSave).getTime() || 0 : 0;
            const wpCount = Array.isArray(data.waypoints) ? data.waypoints.length : 0;
            const quality = ts * 1e3 + wpCount;
      ...
      try {
        ...
        fs.writeFile(plugin.fileBackupPath, json, "utf8", (err) => {
          ...
          if (plugin._writePending) {
            ...
            writeFileBackup2(plugin, pendingData);
          }
          if (err) {
          ...
          try {
            ...
            try {
              const data2 = fs.readFileSync(plugin.fileBackupPath);
              fs.writeFileSync(`${plugin.fileBackupPath}.bak1`, data2);
            } catch (_) {
            }
          }
        });
...
module.exports = class ShadowExchange {
  ...
  _getTeleportCooldownMs() {
    ...
    if (portalCore == null ? void 0 : portalCore.getTeleportCooldownMs) return portalCore.getTeleportCooldownMs();
  ...
  _getPlayerRank() {
    var _a, _b, _c;
    try {
      return ((_c = (_b = (_a = BdApi.Plugins.get("SoloLevelingStats")) == null ? void 0 : _a.instance) == null ? void 0 : _b.settings) == null ? void 0 : _c.rank) || null;
    } catch {
      return null;
    }
  }
  ...
  _checkTeleportCooldown() {
    ...
    const portalCore = _EmbeddedShadowPortalCore || typeof window !== "undefined" && window.ShadowPortalCore;
    if (portalCore == null ? void 0 : portalCore.checkTeleportCooldown) return portalCore.checkTeleportCooldown();
  ...
  start() {
    ...
    try {
      ...
      this._lastTeleportTime = BdApi.Data.load("ShadowPortalCore", "_lastTeleportTime") || BdApi.Data.load(SE_PLUGIN_ID, "_lastTeleportTime") || 0;
      ...
      if (this._getSkillTreeSkillLevel("shadow_exchange") >= 1) {
        ...
        const RETRY_DELAYS = [1e3, 3e3, 6e3];
        ...
        const retryCheck = () => {
          ...
          if (this._getSkillTreeSkillLevel("shadow_exchange") >= 1) {
            this._activateExchangeResources();
            (_a2 = this._startupRetryTimers) == null ? void 0 : _a2.forEach((t) => clearTimeout(t));
  ...
  _activateExchangeResources() {
    ...
    const cdText = cd >= 36e5 ? `${cd / 36e5}h` : `${Math.round(cd / 6e4)}min`;
  ...
  async getWeakestAvailableShadow() {
    ...
    try {
      ...
      let sensesDeployedIds = /* @__PURE__ */ new Set();
      try {
        if (BdApi.Plugins.isEnabled("ShadowSenses")) {
          const ssInstance = (_b = BdApi.Plugins.get("ShadowSenses")) == null ? void 0 : _b.instance;
          const deployments = (_d = (_c = ssInstance == null ? void 0 : ssInstance.deploymentManager) == null ? void 0 : _c.getDeployments) == null ? void 0 : _d.call(_c);
      ...
      const available = allShadows.filter((s) => (s == null ? void 0 : s.id) && !this.isShadowMarked(s.id) && !sensesDeployedIds.has(String(s.id)));
  ...
  async getAvailableShadowCount() {
    ...
    try {
      ...
      try {
        if (BdApi.Plugins.isEnabled("ShadowSenses")) {
          const ssInstance = (_a = BdApi.Plugins.get("ShadowSenses")) == null ? void 0 : _a.instance;
          const deployments = (_c = (_b = ssInstance == null ? void 0 : ssInstance.deploymentManager) == null ? void 0 : _b.getDeployments) == null ? void 0 : _c.call(_b);
          if (Array.isArray(deployments)) {
            sensesDeployedIds = new Set(deployments.map((d) => String(d.shadowId)));
          }
        }
      ...
      const snapshot = (_d = saInstance.getShadowSnapshot) == null ? void 0 : _d.call(saInstance);
      if (Array.isArray(snapshot)) {
        return snapshot.filter((s) => (s == null ? void 0 : s.id) && !this.isShadowMarked(s.id) && !sensesDeployedIds.has(String(s.id))).length;
      }
      const sm = saInstance.storageManager;
      if (sm && typeof sm.getTotalCount === "function") {
        const total = Number(await sm.getTotalCount()) || 0;
        const markedCount = ((_f = (_e = this.getMarkedShadowIds) == null ? void 0 : _e.call(this)) == null ? void 0 : _f.size) || 0;
        return Math.max(0, total - markedCount - sensesDeployedIds.size);
      }
      const all = await saInstance.getAllShadows();
      if (!Array.isArray(all)) return 0;
      return all.filter((s) => (s == null ? void 0 : s.id) && !this.isShadowMarked(s.id) && !sensesDeployedIds.has(String(s.id))).length;
    } catch (_) {
      return 0;
    }
  }
  ...
  teleportTo(waypointId) {
    ...
    const _stampCooldown = () => {
      if (portalCore == null ? void 0 : portalCore.stampTeleportCooldown) {
  ...
  _attachSwirlIconToHeader(icon = null) {
    ...
    if (!isVc) {
      try {
        ...
        const m = path.match(/^\/channels\/(?:@me|\d+)\/(\d+)/);
        if (m) {
          const ch = (_e = (_d = this.ChannelStore || ((_c = (_b = BdApi == null ? void 0 : BdApi.Webpack) == null ? void 0 : _b.getStore) == null ? void 0 : _c.call(_b, "ChannelStore"))) == null ? void 0 : _d.getChannel) == null ? void 0 : _e.call(_d, m[1]);
          const t = Number(ch == null ? void 0 : ch.type);
