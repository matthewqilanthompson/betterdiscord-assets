...
var require_plugin_bridge = __commonJS({
  "src/shared/plugin-bridge.js"(exports2, module2) {
    ...
    module2.exports = { getPluginInstance, getSkillTreeLevel: getSkillTreeLevel2, getSoloLevelingData, invalidatePluginInstance };
  }
});
    ...
    var methods = {
      ...
      _navigateOnce(path) {
        ...
        try {
          ...
          const { getNavigationUtils: getNavigationUtils2 } = require_navigation();
          const nav = getNavigationUtils2();
...
var require_components = __commonJS({
  "src/ShadowStep/components.js"(exports2, module2) {
    function buildComponents2(BdApi2, pluginRef) {
      const { onKeydown: onKeydown2 } = require_dom_bus();
...
Uses: ${anchor.useCount}`
      ...
      function AnchorPanel({ onClose }) {
        ...
        useEffect(() => {
          ...
          const unsub = onKeydown2(handler, { capture: true });
          return () => unsub();
        }, [onClose]);
...
var require_settings_panel = __commonJS({
  "src/ShadowStep/settings-panel.js"(exports2, module2) {
    ...
    var SETTINGS_LABEL_STYLE = { color: "#dcddde", fontSize: "13px" };
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { style: { color: "#b5bac1", fontSize: "11px" } },
...
var { loadSettings: _sharedLoadSettings, saveSettings: _sharedSaveSettings } = require_settings();
var { onKeydown } = require_dom_bus();
var { getSkillTreeLevel } = require_plugin_bridge();
...
var matchesHotkey = _sharedMatchesHotkey;
...
module.exports = class ShadowStep {
  ...
  start() {
    ...
    this._onSkillLevelChanged = (e) => {
      var _a2;
      if (((_a2 = e.detail) == null ? void 0 : _a2.skillId) !== "shadow_exchange") return;
  ...
  _teardownStepRuntime() {
    ...
    (_b = _TransitionCleanupUtils == null ? void 0 : _TransitionCleanupUtils.cancelPendingTransition) == null ? void 0 : _b.call(_TransitionCleanupUtils, this);
    if (this._transitionNavTimeout) {
      clearTimeout(this._transitionNavTimeout);
      this._transitionNavTimeout = null;
    }
    ...
    (_c = _TransitionCleanupUtils == null ? void 0 : _TransitionCleanupUtils.clearNavigateRetries) == null ? void 0 : _c.call(_TransitionCleanupUtils, this);
    if ((_d = this._navigateRetryTimers) == null ? void 0 : _d.size) {
  ...
  renameAnchor(anchorId, newName) {
    ...
    if (exists) {
      this.settings.anchors = this.settings.anchors.map(
        (a) => a.id === anchorId ? { ...a, name: newName } : a
      );
      this._rebuildAnchorIndex();
  ...
  teleportTo(anchorId) {
    ...
    const isMonarch = (() => {
      var _a2, _b2, _c2;
      try {
        return ((_c2 = (_b2 = (_a2 = BdApi.Plugins.get("SoloLevelingStats")) == null ? void 0 : _a2.instance) == null ? void 0 : _b2.settings) == null ? void 0 : _c2.rank) === "Shadow Monarch";
      } catch (_) {
        return false;
      }
    })();
    const portalCore = _EmbeddedShadowPortalCore || typeof window !== "undefined" && window.ShadowPortalCore;
    if (!isMonarch && (portalCore == null ? void 0 : portalCore.checkTeleportCooldown)) {
      const cdCheck = portalCore.checkTeleportCooldown();
      if (cdCheck.onCooldown) {
        this._toast(`Teleport on cooldown \u2014 ${cdCheck.remainingText} remaining`, "error", 3e3);
        return;
      }
    }
    ...
    const _now = Date.now();
    this.settings.anchors = this.settings.anchors.map(
      (a) => a.id === anchor.id ? { ...a, lastUsed: _now, useCount: (a.useCount || 0) + 1 } : a
    );
    this.scheduleSaveSettings();
  ...
  openPanel() {
    ...
    if (!((_a = this._components) == null ? void 0 : _a.AnchorPanel)) {
      this.debugError("Panel", "Cannot open panel: AnchorPanel component unavailable");
      return;
    }
    const _t = ((_b = this.settings) == null ? void 0 : _b.debugMode) ? [performance.now()] : null;
    const container = document.createElement("div");
    container.id = PANEL_CONTAINER_ID;
    document.body.appendChild(container);
    _t && _t.push(performance.now());
    const createRoot = (_c = BdApi.ReactDOM) == null ? void 0 : _c.createRoot;
    if (createRoot) {
    ...
    if (_t) {
      ...
      this.debugLog("Panel", "OPEN TIMING", {
        ...
        anchors: (((_d = this.settings) == null ? void 0 : _d.anchors) || []).length
      });
    }
